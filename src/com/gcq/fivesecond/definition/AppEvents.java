...
public class AppEvents
{
	...
	public static final int EVENT_START_PLAYER_ROUND = EVENT_BASE + 6;
	public static final int EVENT_START_RED_ROUND = EVENT_BASE + 7;
	public static final int EVENT_START_TARGET_ROUND_DISC = EVENT_BASE + 8;
	...
	public static final int EVENT_END_PLAYER_ROUND = EVENT_BASE + 11;
	public static final int EVENT_END_RED_ROUND = EVENT_BASE + 12;
	public static final int EVENT_END_TARGET_ROUND_DISC = EVENT_BASE + 13;
	public static final int EVENT_EXIT = EVENT_BASE + 14;
	
	public static final int EVENT_NEXT_DEST=EVENT_BASE+15;
	public static final int EVENT_TRANSITION_TO_GAME_OVER_SCENE = EVENT_BASE + 16;
}
